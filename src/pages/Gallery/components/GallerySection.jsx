        ...
        <div className="gallery-grid-2 h-full">
          ...
          <div className="image2 relative">
            <button
              ...
              onClick={() => goToPrevious(currentIndex1, setCurrentIndex1, images1.length)}
            >
              <img src={ArrowL} alt="Previous" />
            </button>
            <img src={images1[currentIndex1]} className="gallery-img-1a" alt="carousel" />
            <button
              className="carousel-arrow right"
              onClick={() => goToNext(currentIndex1, setCurrentIndex1, images1.length)}
            >
...
{/* GALLERY 3 */}
      <div className="mx-20 mt-10">
        <div className="gallery-grid-3 h-full">
          ...
          <img src={images4[currentIndex4]} className="gallery-img-9" alt="carousel" />
...
{/* GALLERY 4 */}
      <div className="mx-20 mt-10">
        <div className="gallery-grid-4 h-full">
          ...
          <button
              className="carousel-arrow left"
              onClick={() => goToPrevious(currentIndex2, setCurrentIndex2, images2.length)}
            >
              <img src={ArrowL} alt="Previous" />
            </button>
            <img src={images2[currentIndex2]} className="gallery-img-11" alt="carousel" />
            <button
              className="carousel-arrow right"
              onClick={() => goToNext(currentIndex2, setCurrentIndex2, images2.length)}
            >
              <img src={ArrowR} alt="Next" />
            </button>
            <div className="carousel-dots">
      ...
      <div className="mx-20 mt-10">
        <div className="gallery-grid-2 h-full">
          ...
          <div className="image2 relative">
            <button
              className="carousel-arrow left"
              onClick={() => goToPrevious(currentIndex6, setCurrentIndex6, images1.length)}
            >
              <img src={ArrowL} alt="Previous" />
            </button>
            <img src={images6[currentIndex6]} className="gallery-img-1a" alt="carousel" />
            <button
              className="carousel-arrow right"
              onClick={() => goToNext(currentIndex6, setCurrentIndex6, images1.length)}
            >
              <img src={ArrowR} alt="Next" />
            </button>
            <div className="carousel-dots">
...
{/* GALLERY 7 */}
      <div className="mx-20 mt-10">
        <div className="gallery-grid-3 h-full">
          ...
          <img src={images7[currentIndex7]} className="gallery-img-9" alt="carousel" />
...
{/* GALLERY 8 */}
      <div className="mx-20 mt-10">
        <div className="gallery-grid-4 h-full">
          ...
          <button
              className="carousel-arrow left"
              onClick={() => goToPrevious(currentIndex8, setCurrentIndex8, images2.length)}
            >
              <img src={ArrowL} alt="Previous" />
            </button>
            <img src={images8[currentIndex8]} className="gallery-img-11" alt="carousel" />
            <button
              className="carousel-arrow right"
              onClick={() => goToNext(currentIndex8, setCurrentIndex8, images2.length)}
            >
              <img src={ArrowR} alt="Next" />
            </button>
            <div className="carousel-dots">
